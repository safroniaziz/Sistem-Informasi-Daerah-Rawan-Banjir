		...
		<div id="particles-js">
            <div class="loginBox">
                ...
                @if ($message = Session::get('error'))
                    ...
                    @else
                    <h6>Login Administrator</h6>
                    <p style="text-align:center; margin-bottom:20px;">Sistem Informasi Daerah Rawan Banjir Kota Bengkulu</p>
                @endif
                <form method="post" action="{{ route('login') }}">
                    ...
                    <a href="#" style="font-weight:200; font-style:italic;">v 1.0</a>
                </form>
            </div>
        </div>
    </body>
